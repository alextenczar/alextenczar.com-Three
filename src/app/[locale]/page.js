    ...
    <main className={styles.main}>
      ...
      <div className="grid md:grid-rows-6 md:grid-cols-2 gap-6">
        ...
        <div className='bento observe-scroll md:col-span-2'>
          ...
          <h3 className='text-lg text-neutral-500 font-normal'>{t('education.subtitle')}</h3>
          <div className="grid grid-cols-22 md:grid-rows-5 grid-rows-[auto] text-xs mt-6 education-timeline max-md:min-h-80">
            <div className="py-2 col-span-22 grid grid-cols-subgrid items-center"><div className="timeline-label px-2 col-start-11 col-span-11 rounded-full font-bold self-end">{t('education.launchtheory')}</div><Link aria-label="Launch Theory" href="https://launchtheory.com" target="_blank" className="timeline-item h-3 col-start-11 col-span-11 bg-purple-500 rounded-full">&nbsp;</Link></div>
            <div className="col-span-22 grid grid-cols-subgrid grid-rows-2 items-center"><div className="timeline-label px-2 col-start-9 col-span-11 rounded-full font-bold self-end">{t('education.internship')}</div><Link aria-label="CommonPlaces" href="https://commonplaces.com" target="_blank" className="timeline-item h-3 col-start-9 col-span-2 bg-green-500 rounded-full">&nbsp;</Link></div>
            <div className="col-span-22 grid grid-cols-subgrid items-center"><div className="timeline-label px-2 col-start-8 col-span-13 rounded-full font-bold self-end">{t('education.grad')}</div><Link aria-label="UNH" href="https://unh.edu" target='_blank' className="timeline-item  h-3 col-start-8 col-span-4 bg-orange-500 rounded-full">&nbsp;</Link></div>
            <div className="col-span-22 grid grid-cols-subgrid items-center"><div className="timeline-label px-2 col-start-2 col-span-22 rounded-full font-bold self-end">{t('education.undergrad')}</div><Link aria-label="UNH" href="https://unh.edu" target='_blank' className="timeline-item  h-3 col-start-2 col-span-8 bg-blue-500 rounded-full">&nbsp;</Link></div>
            <div className="py-2 col-span-22 grid grid-cols-subgrid text-gray-400 text-[11px] items-end"><div className="col-span-2">2016</div><div className="col-span-2">2017</div><div className="col-span-2">2018</div><div className="col-span-2">2019</div><div className="col-span-2">2020</div><div className="col-span-2">2021</div><div className="col-span-2">2022</div><div className="col-span-2">2023</div><div className="col-span-2">2024</div><div className="col-span-2">2025</div><div className="col-span-2">2026</div></div>
          </div>
        </div>

        <div className='bento observe-scroll flex flex-col max-md:min-h-80'>
          <h2 className='text-4xl font-bold'>{t('skills.title')}</h2>
          <h3 className='text-lg text-neutral-500 font-normal'>{t('skills.subtitle')}</h3>
        ...
        <Link aria-label={t('photography.title')} href="/photo">
          <div className='bento-photo bento observe-scroll row-span-1 max-md:min-h-64'>
            ...
            <h3 className='text-lg text-neutral-500 font-normal'>{t('photography.subtitle')}</h3>
            <ImageTeaser />
          </div>
        </Link>
