      ...
      <div className="grid md:grid-rows-6 md:grid-cols-2 gap-6">
        ...
        <div className='bento observe-scroll md:col-span-2'>
          ...
          <div className="grid grid-cols-20 grid-rows-5 text-xs mt-6 education-timeline max-md:min-h-80">
            ...
            <div className="col-span-20 grid grid-cols-subgrid"><div className="timeline-label px-2 col-start-2 col-span-20 rounded-full font-bold self-end">{t('education.undergrad')}</div><Link href="https://unh.edu" target='_blank' className="timeline-item  h-3 col-start-2 col-span-8 bg-blue-500 rounded-full">&nbsp;</Link></div>
