  ...
  return (
    <main className={styles.main}>
      ...
      <div className="grid md:grid-rows-6 md:grid-cols-2 gap-6">
        ...
        <Link href="/works"><ProjectsBento title={t('works.title')} subtitle={t('works.subtitle')} /></Link>
        <div className='bento observe-scroll md:col-span-2'>
          ...
          <div className="grid grid-cols-20 md:grid-rows-5 grid-rows-[auto] text-xs mt-6 education-timeline max-md:min-h-80">
            ...
            <div className="col-span-20 grid grid-cols-subgrid items-center"><div className="timeline-label px-2 col-start-8 col-span-13 rounded-full font-bold self-end">{t('education.grad')}</div><Link href="https://unh.edu" target='_blank' className="timeline-item  h-3 col-start-8 col-span-4 bg-orange-500 rounded-full">&nbsp;</Link></div>
            <div className="col-span-20 grid grid-cols-subgrid items-center"><div className="timeline-label px-2 col-start-2 col-span-20 rounded-full font-bold self-end">{t('education.undergrad')}</div><Link href="https://unh.edu" target='_blank' className="timeline-item  h-3 col-start-2 col-span-8 bg-blue-500 rounded-full">&nbsp;</Link></div>
        ...
        <Link href="/blog"><BlogBento title={t('blog.title')} subtitle={t('blog.subtitle')} /></Link>
        ...
        <div className='bento bento-contact observe-scroll row-span-1 md:col-span-2 max-md:min-h-64'>
          ...
          <div className='bento-contact-container'>
            <Link href="https://github.com/alextenczar" target="_blank" rel="noopener noreferrer" className="github-link">
            ...
            <Link href="https://www.linkedin.com/in/alexander-tenczar/" target="_blank" rel="noopener noreferrer" className="linkedin-link">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z" /></svg>
            </Link>
            <Link href="https://www.wantedly.com/id/alexander_tenczar" target="_blank" rel="noopener noreferrer" className="wantedly-link">
            ...
            <Link href="/contact" target="_blank" rel="noopener noreferrer" className="email-link">
